...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:eg="http://www.tei-c.org/ns/Examples"
    ...
    <xsl:variable name="htmlFooter">
        <footer> Powered by <a href="{$teibpHome}">TEI Boilerplate</a>. TEI Boilerplate is licensed under a <a
            ...
            href="http://creativecommons.org/licenses/by/3.0/"><img alt="Creative Commons License" style="border-width:0;"
            src="http://i.creativecommons.org/l/by/3.0/80x15.png"/></a> </footer>
    </xsl:variable>
            ...
            <xsl:when test="$displayPageBreaks = true()">
                <span class="-teibp-pb">
                    ...
                    <xsl:call-template name="pb-handler">
                        ...
                        <!-- as in my editions, I ususally use the @facs to point to a surface element, some work is needed to make this work -->
